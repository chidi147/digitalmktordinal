...
import { Digitalmktordinal } from '../src/contracts/digitalmktordinal'
...
async function main() {
    await Digitalmktordinal.compile()
    ...
    const instance = new Digitalmktordinal(
    ...
    console.log('Digitalmktordinal contract was successfully deployed!')
